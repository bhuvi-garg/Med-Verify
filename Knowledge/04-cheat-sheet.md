...
Keep this page open in a tab while you work. It's a quick reminder, not a full explanation — if something doesn't make sense, go back to [01](01-what-is-git-and-github.md), [02](02-first-time-setup.md), or [03](03-everyday-workflow.md).
...
| `git pull` | Downloads everyone else's latest commits from GitHub. Run this **before** you start working. |
